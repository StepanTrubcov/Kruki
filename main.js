...
bot.start((ctx) => {
  ctx.reply('🔧 Бот в разработке — ваша помощь важна!\n\nПриветствую! Сейчас я активно дорабатываю этого бота-помощника по крюковой нотации. Вы одни из первых, кто его тестирует!\n\nКак можно помочь?\n1️⃣ Протестируйте уроки (первые 5 доступны уже сейчас) — и расскажите, что можно улучшить.\n2️⃣ Скоро будет:\nПодписка на все уроки 200₽\n3️⃣ Если бот уже вам помог — поддержите проект добровольным пожертвованием. Даже 50₽ ускорят разработку!\n\nПочему это важно?\nВаша обратная связь и поддержка помогут сделать бота по-настоящему полезным для всех, кто изучает церковное пение.\n\n📌 Спасибо, что вы с нами на этом пути!')

  ctx.reply("🎵 Добро пожаловать в мир древнерусского церковного пения!\n\nЭтот бот поможет вам:\n• Изучить крюковую нотацию с нуля\n• Проверить знания в интерактивных тестах\n• Отточить навыки на тренажёрах\n\nВыберите действие:\nУроки — Пошаговое изучение крюков\nТесты — Проверка знаний\nТренажёр — Практика распознавания символов\n\nНачните с урока или сразу испытайте себя в тесте!", {
    reply_markup: {
      inline_keyboard: [
        [
        ...
        [
          { text: "🏋️ Тренажёр лестницы", callback_data: "staircase_simulator" },
          { text: "ℹ️ О крюках", callback_data: "kruki" }
        ],
        [
...
bot.command("test", (ctx) => {
  return ctx.reply("🧠 Проверьте свои знания\nПосле прохождения вы узнаете свой уровень и получите рекомендации!", {
    reply_markup: {
      inline_keyboard: [
        [{ text: "Тест 1 (по Уроку 1) — 5 вопросов", callback_data: "test_1" }, { text: "Тест 2 (по Уроку 2) — 11 вопросов", callback_data: "test_2" }],
        [{ text: "Тест 3 (по Уроку 3) — 8 вопросов", callback_data: "test_3" }]
      ],
    },
  });
});
...
bot.command("lessons", (ctx) => {
  return ctx.reply("📚 Уроки крюкового письма\nКаждый урок — это шаг к мастерству!\nРекомендуем проходить по одному уроку в день для лучшего усвоения.", {
    reply_markup: {
      inline_keyboard: [
        [
          { text: "Урок 1 — (пометы)", callback_data: "lesson_1" },
          { text: "Урок 2 — (крюк и параклит)", callback_data: "lesson_2" }
        ],
        [
          { text: "Урок 3 — (стопица, запитая, палка)", callback_data: "lesson_3" },
          { text: "Урок 4 - (ключь, челюстка, подчашие, скамейци, палки)", callback_data: "lesson_4" },
        ],
        [
    ...
    return ctx.reply("📚 Уроки крюкового письма\nКаждый урок — это шаг к мастерству!\nРекомендуем проходить по одному уроку в день для лучшего усвоения.", {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "Урок 1 — (пометы)", callback_data: "lesson_1" },
            { text: "Урок 2 — (крюки, параклиты )", callback_data: "lesson_2" }
          ],
          [
            { text: "Урок 3 — (стопицы, запитыи, палки)", callback_data: "lesson_3" },
            { text: "Урок 4 - (ключь, челюстка, подчашие, скамейци, палки)", callback_data: "lesson_4" },
          ],
          [
            { text: "Урок 5 - (дербица, переводки, голубчики,чашки)", callback_data: "lesson_5" },
