    ...
    reply_markup: {
      inline_keyboard: [
        ...
        [
          ...
          { text: "🔁 Практика", callback_data: "practice" }
        ],
        [
  ...
  if (buttonData === "lessons") {
    return ctx.reply("📚 Уроки крюкового письма\nКаждый урок — это шаг к мастерству!\nРекомендуем проходить по одному уроку в день для лучшего усвоения.", {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "Урок 1 — Основные знамёна (крюк, палка, стрела)", callback_data: "lesson_1" },
            { text: "Урок 2 — Сложные фигуры (подчашие, запятая)", callback_data: "lesson_2" }
          ],
          [
            { text: "Урок 3 — Ритмические обозначения", callback_data: "lesson_3" },
          ],
        ],
      },
    });
